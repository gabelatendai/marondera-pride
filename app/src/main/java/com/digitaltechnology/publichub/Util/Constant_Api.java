...
public class Constant_Api {
    ...
    //main server api url
    public static String url = "http://gmusodza.kacee.co.zw/maronderapride/";

    public static String MY_PREFS_NAME="maronderapride";
    public static final String APP_TEMP_FOLDER = "maronderapride";
