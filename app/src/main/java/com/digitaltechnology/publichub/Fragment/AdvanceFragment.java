...
public class AdvanceFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progressBar = (AVLoadingIndicatorView) view.findViewById(R.id.progresbar_advance);
        recyclerView = view.findViewById(R.id.recyclerView_advance);
        ...
        client.get(Constant_Api.menu, null, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    ...
                    JSONArray jsonArray = jsonObject.getJSONArray("ADVANCE_CATEGORY_LIST");
